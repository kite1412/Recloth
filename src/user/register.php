...
<body class="min-h-screen flex items-center justify-center p-4 md:p-6 lg:p-8">
    ...
    <div class="w-full max-w-6xl bg-[var(--white)] backdrop-blur-2xl border border-[var(--glass-border)] rounded-3xl overflow-hidden shadow-2xl flex flex-col lg:flex-row min-h-[650px] lg:min-h-[750px]">
        ...
        <div class="lg:w-7/12 flex flex-col justify-center items-center p-8 sm:p-12 md:p-16 relative">
            ...
            <div class="w-full max-w-md">
                <div class="text-center lg:text-left mb-8 mt-8 lg:mt-0">
                    <h2 class="text-3xl sm:text-4xl font-bold tracking-tight text-white mb-3">Buat Akun Baru</h2>
                    <p class="text-[var(--muted)] font-medium">Lengkapi data di bawah ini untuk bergabung dengan Recloth.</p>
                </div>
                ...
                <form id="registerForm" method="POST" action="../config/register_process.php" class="space-y-5">
                    ...
                    <div class="space-y-1.5">
                        <label for="address" class="block text-sm font-semibold text-gray-300">Alamat Lengkap</label>
                        <div class="relative">
                            ...
                            <textarea
                                ...
                                class="form-input w-full rounded-xl border border-[rgba(255,255,255,0.1)] bg-[rgba(255,255,255,0.05)] pl-11 pr-4 py-3 text-sm text-white placeholder-gray-500 outline-none resize-none"
                                required
                            ></textarea>
                        </div>
                    </div>
                    ...
                    <div class="space-y-1.5">
                        <label for="zip_code" class="block text-sm font-semibold text-gray-300">Kode Pos</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div class="space-y-1.5">
                            <label for="password_confirm" class="block text-sm font-semibold text-gray-300">Ulangi Password</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="pt-2">
                        <label class="flex items-start gap-3 cursor-pointer">
                            <div class="pt-0.5">
                                <input type="checkbox" id="terms" class="w-4 h-4 rounded border-[rgba(255,255,255,0.2)] bg-[rgba(255,255,255,0.05)] text-[var(--accent)] focus:ring-[var(--accent)] accent-[var(--accent)]">
                            </div>
                            <span class="text-sm text-[var(--muted)] leading-relaxed">
                                Dengan mendaftar, saya menyetujui <a href="terms.php" target="_blank" class="font-semibold text-[var(--accent)] hover:underline">Syarat & Ketentuan</a> serta <a href="privacy.php" target="_blank" class="font-semibold text-[var(--accent)] hover:underline">Kebijakan Privasi</a> yang berlaku.
                            </span>
                        </label>
                    </div>

                    <button type="submit" class="btn-register w-full rounded-xl py-3.5 text-sm font-bold text-[#111] shadow-[0_4px_15px_rgba(212,175,55,0.3)] mt-6 flex justify-center items-center gap-2 group hover:shadow-[0_8px_25px_rgba(212,175,55,0.5)] bg-gradient-to-r from-[var(--accent)] to-[#fef08a] border-none">
                ...
                <div class="mt-8 pt-6 border-t border-[rgba(255,255,255,0.1)] flex flex-col gap-4">
                    <p class="text-center text-sm font-medium text-[var(--muted)]">
                        Sudah punya akun?
                        <a href="login.php" class="font-bold text-[var(--accent)] hover-underline ml-1">Masuk di sini</a>
                    </p>
